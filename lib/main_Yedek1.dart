...
class _MyAppState extends State<MyApp> {
  ...
  play() async {
    ...
    //int result = await audioPlayer.play('https://firebasestorage.googleapis.com/v0/b/cloud2-f6bda.appspot.com/o/music%2Fa1.mp3?alt=media&token=437bc1e0-2447-4e11-ae38-5c6684ba090f');
    int result = await audioPlayer.play('https://1firebasestorage.googleapis.com/v0/b/cloud2-f6bda.appspot.com/o/music%2Fa1.mp3?alt=media&token=437bc1e0-2447-4e11-ae38-5c6684ba090f1xxxxx');
    if (result == 1) {
      // success
      print(result);
    }
