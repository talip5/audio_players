...
class _MyAppState extends State<MyApp1> {
  ...
  copy() async {
    ...
    List<dynamic> list = downloadDir.listSync();
    //print(list);
    File downloadFile = File('$downloadPath/deneme2.mp3');
    print(downloadFile);
    await downloadFile.copy('$musicPath/deneme2.mp3');
    print('$downloadFile is copyed');
  }
  ...
  completionEvent() async {
    ...
    setState(() {
      songTitle = songPlayList[currentIndex].split('/').last;
    });
