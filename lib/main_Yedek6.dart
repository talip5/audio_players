...
class _MyAppState extends State<MyApp1> {
  ...
  write() async {
    ...
    //File file = File('$path35/deneme10.mp3');
  ...
  write1() async {
    ...
    //print(response.bodyBytes);
    var responceRecord=response.bodyBytes;
    print(responceRecord.length);
    responceRecord.forEach((element) {
      if(recordCount<100){
        record1.add(element);
        recordCount++;
      }
    ...
    print(record1);
    Uint8List bytes1=Uint8List.fromList(record1);
    print(bytes1);
    String path35 = '/storage/emulated/0/Download';
    File file = File('$path35/deneme10.mp3');
    await file.writeAsBytes(bytes1);
    print('Dosya kaydedildi.');
  }
